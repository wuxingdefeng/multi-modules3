      ...
      select: function(){
        ...
        selects.each(function(index, select){
          ...
          var reElem = $(['<div class="layui-unselect '+ CLASS +'">'
            ,'<div class="'+ TITLE +'"><input type="text" placeholder="'+ (select.options[0].innerHTML ? select.options[0].innerHTML : TIPS) +'" value="'+ (value ? selected.html() : '') +'" disabled="true" readonly class="layui-input layui-unselect">'
